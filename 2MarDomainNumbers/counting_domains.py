...
domain_numbers={}
with open(my_out_path+"/clusterTableNonRedundant.6dbs.correct_domains.txt",'w') as output_file1:
    ...
    for i in range(1,len(cluster_list1)):
        ...
        info= line.split("\t")
        accession=info[0]
        cluster_num=info[4][8:]
        if len(cluster_num)==1:
            cluster_n="00"+cluster_num
        elif len(cluster_num)==2:
            cluster_n="0"+cluster_num
        elif len(cluster_num)==3:
            cluster_n=cluster_num
        subfoldername=accession+"/"
        filename=accession+".cluster"+cluster_n
        ...
        for feature in record.features:
            if feature.type=="aSDomain":
                ...
                # PKS domains
                if feature.qualifiers.get("domain")[0]=="CAL_domain":
                    n_CAL+=1

                if feature.qualifiers.get("domain")[0]=="PKS_KS":
                    n_KS+=1
  
                elif feature.qualifiers.get("domain")[0]=="PKS_AT":
                    n_AT+=1

                elif feature.qualifiers.get("domain")[0]=="GNAT" :
                    n_GNAT+=1

                elif feature.qualifiers.get("domain")[0]=="Trans-AT_docking":
                    n_tATd+=1

                elif feature.qualifiers.get("domain")[0]=="PKS_KR":
                    n_KR+=1

                elif feature.qualifiers.get("domain")[0]=="PKS_DH" or feature.qualifiers.get("domain")[0]=="PKS_DH2" or feature.qualifiers.get("domain")[0]=="PKS_DHt":
                    n_DH+=1


                elif feature.qualifiers.get("domain")[0]=="PKS_ER":
                    n_ER+=1

                elif feature.qualifiers.get("domain")[0]=="Hal":
                    n_Hal+=1

                elif feature.qualifiers.get("domain")[0]=="ECH":
                    n_ECH+=1

                elif feature.qualifiers.get("domain")[0]=="PS":
                    n_PS+=1

                elif feature.qualifiers.get("domain")[0]=="PKS_ACP":
                    n_ACP+=1

                elif feature.qualifiers.get("domain")[0]=="ACP_beta" :
                    n_ACPb+=1

                elif feature.qualifiers.get("domain")[0]=="Polyketide_cyc" :
                    n_CYC+=1



                #NRPS domains
                elif feature.qualifiers.get("domain")[0]=="Condensation":
                    n_C+=1

                elif feature.qualifiers.get("domain")[0]=="AMP-binding":
                    n_A+=1

                elif feature.qualifiers.get("domain")[0]=="Epimerization":
                    n_E+=1

                elif feature.qualifiers.get("domain")[0]=="F":
                    n_F+=1

                elif feature.qualifiers.get("domain")[0]=="Heterocyclization":
                    n_H+=1  

                elif feature.qualifiers.get("domain")[0]=="PCP":
                    n_PCP+=1



                # PKS/NRPS domains
                elif feature.qualifiers.get("domain")[0]=="Aminotran_1_2" or feature.qualifiers.get("domain")[0]=="Aminotran_3" or feature.qualifiers.get("domain")[0]=="Aminotran_4" or feature.qualifiers.get("domain")[0]=="Aminotran_5":
                    n_AmT+=1

                elif feature.qualifiers.get("domain")[0]=="MT" or feature.qualifiers.get("domain")[0]=="cMT" or feature.qualifiers.get("domain")[0]=="nMT" or feature.qualifiers.get("domain")[0]=="oMT":
                    n_MT+=1

                elif feature.qualifiers.get("domain")[0]=="FkbH":
                    n_FkbH+=1

                elif feature.qualifiers.get("domain")[0]=="Thioesterase":
                    n_TE+=1

                elif feature.qualifiers.get("domain")[0]=="TD":
                    n_TD+=1

                elif feature.qualifiers.get("domain")[0]=="NAD_binding_4":
                    n_NADb+=1
...
with open(my_out_path+"/clusterTableNonRedundantNonSimilar.6dbs.prot_len.correct_domains.txt",'w') as output_file2:
