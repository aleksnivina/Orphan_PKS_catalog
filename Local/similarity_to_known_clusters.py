...
known_clusters_main={}
with open("../10_looking_for_nonorphans/known_clusters_MIBig_and_clusterTable_matched_to_all_leaves_edited.txt",'r') as known_cluster_file:
...
with open("Max_similarity_to_known_cluster.txt",'w') as output_file:
...
n, bins, patches=ax1.hist(distances_to_known_clusters,bins=bins,color="lightgray",align='mid')
...
plt.title("Similarity of orphan clusters\nto known ones")
plt.savefig("Similarity_to_known_clusters.pdf")
...
plt.title("Similarity of orphan clusters\nto known ones")
plt.savefig("Similarity_to_known_clusters_log.pdf")
