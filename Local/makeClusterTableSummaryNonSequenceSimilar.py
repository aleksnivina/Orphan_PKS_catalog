...
for i in range(1,len(cluster_list)):
    ...
    curr_cluster_num=info[4][7:].strip(" ")
...
n_redund_sets=0
n_nonredund=0
with open(output_folder+"/clusterTableNonRedundantNonSimilarNonSequenceSimilar.6dbs.prot_len.correct_domains.txt",'w') as output_file:
