...
while(<IN>) {
  ...
  my $num_kss = get_num_domains($local_antismash_image_file, "KS"); #HERE
  my $num_ats = get_num_domains($local_antismash_image_file, "AT");
  my $num_acps = get_num_domains($local_antismash_image_file, "ACP");
  my $num_krs = get_num_domains($local_antismash_image_file, "KR");
  my $num_dhs = get_num_domains($local_antismash_image_file, "DH");
  my $num_ers = get_num_domains($local_antismash_image_file, "ER");
  my $num_cs = get_num_domains($local_antismash_image_file, "C");
  my $num_as = get_num_domains($local_antismash_image_file, "A");

  my $type = get_cluster_type($genecluster_file, $clusternum); 
