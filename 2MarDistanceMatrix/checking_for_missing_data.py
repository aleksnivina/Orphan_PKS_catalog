...
with open("List_of_unexpected_cluster_pairs_final.txt",'w') as additional_score_file:
        ...
        while counter:
            ...
            if line=="\n" or line=="":
                ...
                if (query2,subject2) in similarity_dict:
                    ...
                    additional_score_file.write("\t".join([query2,subject2]))
                    additional_score_file.write("\n")
...
# output pairs that still have 0 values in the dictionary
with open("List_of_cluster_pairs_with_no_scores_final.txt",'w') as missing_score_file:
    for key in similarity_dict:
        if similarity_dict[key]==0:
            missing_score_file.write("\t".join([key[0],key[1]]))
            missing_score_file.write("\n")
